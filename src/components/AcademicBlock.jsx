...
const AcademicBlock = () => {
   const [academicList, setAcademicList] = useState([{ image: "", more_info: "", imgPreview: "" }]);
   ...
   const handleChange = (e, i) => {
      ...
      if (name == "image") {
         ...
         const fileName = `academics\$${uuidv4()}\$${localStorage.getItem("collegeId")}.${fileExt}`;
   ...
   const handleAddField = (e) => {
      e.preventDefault();
      setAcademicList([...academicList, { image: "", more_info: "", imgPreview: "" }]);
   };
                  ...
                  <GalleryStyle key={i}>
                     <div className="image-block">
                        ...
                        <div className="image-btn">
                           ...
                           <input type="file" style={{ display: "none" }} accept="image/*" id={`academic-upload-${i}`} name={"image"} onChange={(e) => handleChange(e, i)} />
                        </div>
                     </div>

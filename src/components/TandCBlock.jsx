...
export const InputField = ({ title, name, placeholder, required = false }) => {
   return (
      <InputFieldStyle>
         ...
         <div className="field">
            <input type="url" name={name} placeholder={placeholder} required={required} />
         </div>
      </InputFieldStyle>
   );
};
         ...
         <Wrapper>
            ...
            <div className="tnc-right">
               <div className="tnc-links-field">
                  <InputField title={"website"} name="website" placeholder={"www.example.com"} />
                  <InputField title={"facebook"} name={"facebook"} placeholder={"www.facebook.com/example"} />
                  <InputField title={"youtube"} name={"youtube"} placeholder={"www.youtube.com/example"} />
                  <InputField title={"instagram"} name={"instagram"} placeholder={"www.Instagrame.com/college"} />
               </div>

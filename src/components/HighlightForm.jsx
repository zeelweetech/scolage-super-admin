   ...
   const handleFormSubmit = async (e) => {
      ...
      try {
         ...
         const getDescription = (item) => {
            const value = highlightTexts.filter((textarea) => textarea.name === item);
            ...
            <Wrapper>
               <div className="highlight-check-main">
                  {highlightCheckData.map((item, index) => (
                     <HighlightChecks key={index} data={item} name="highlight" highlightTexts={highlightTexts} setHighlightTexts={setHighlightTexts} highlightChecks={highlightChecks} setHighlightChecks={setHighlightChecks} />
                  ))}
               </div>

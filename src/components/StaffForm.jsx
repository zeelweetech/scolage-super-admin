...
const ExperienceField = ({ totalExp, setTotalExp, exp, expOptionTemp, valueTemplate, currentExp, setCurrentExp }) => {
   return (
      <ExperienceFieldStyles>
         ...
         <div className="field">
            <div className="exp-drop total-xp">
               ...
               <Dropdown value={totalExp} onChange={(e) => setTotalExp(e.value)} options={exp} valueTemplate={valueTemplate} itemTemplate={expOptionTemp} />
            </div>
            <div className="exp-drop current-xp">
               <p className="title">current</p>
               <Dropdown value={currentExp} onChange={(e) => setCurrentExp(e.value)} options={exp} valueTemplate={valueTemplate} itemTemplate={expOptionTemp} />
            </div>
         </div>
      </ExperienceFieldStyles>
   );
...
const StaffForm = ({ staffData, setStaffData }) => {
   ...
   const handleSubmit = async (e) => {
      ...
      try {
         ...
         const { data } = await axios.post("/v2/reg/management_staffdetail", formData, {
            headers: {
   ...
   return (
      <form ref={formRef} onSubmit={handleSubmit} encType="multipart/form-data">
         <Wrapper>
               ...
               <div className="field">
                  <div className="profile-avatar">
                     ...
                     <div className="avatar-ctas">
                        ...
                        <input ref={inputRef} onChange={handleChange} type="file" accept="image/*" name="avatar" style={{ display: "none" }} />
            ...
            <InputField title={"name"} name="name" placeholder="Ravindar Narayana" />
            <InputField title={"Qualification"} name="qualification" placeholder="PHD in Science" />
            <ExperienceField totalExp={totalExp} setTotalExp={setTotalExp} currentExp={currentExp} setCurrentExp={setCurrentExp} exp={exp} expOptionTemp={expOptionTemp} valueTemplate={valueTemplate} />
            <InputField title={"Designation"} name="designation" placeholder="Science Teacher" />
            <AboutField />
